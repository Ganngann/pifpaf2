                ...
                <div class="flex flex-wrap items-end gap-4">
                    ...
                    <div class="flex-grow min-w-[180px]">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="number" name="min_price" placeholder="Min" aria-label="Prix minimum" class="w-full px-2 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none" value="{{ request('min_price') }}">
                            <span>-</span>
                            <input type="number" name="max_price" placeholder="Max" aria-label="Prix maximum" class="w-full px-2 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none" value="{{ request('max_price') }}">
                        </div>
                    </div>
                    ...
                    <div class="flex-grow min-w-[180px]">
                         ...
                         <div class="flex items-center gap-2">
                            <input type="text" name="location" placeholder="Autour de..." aria-label="Localisation" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none" value="{{ request('location') }}">
                            <select name="distance" aria-label="Distance de recherche" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none">
                    ...
                    <div class="flex-shrink-0">
                        <button type="submit" class="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none">
                            Rechercher
                        </button>
                    </div>
                </div>
