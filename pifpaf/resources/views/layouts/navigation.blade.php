            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @auth
                        ...
                        <a href="{{ route('items.create') }}" class="inline-flex items-center px-1 pt-1 border-b-2 {{ request()->routeIs('items.create') ? 'border-indigo-400 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} text-sm font-medium leading-5 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">
                            Vendre un article
                        </a>
                    @endauth
                </div>
