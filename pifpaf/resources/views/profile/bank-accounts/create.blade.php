<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Ajouter un nouveau compte bancaire') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('profile.bank-accounts.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="account_holder_name" class="block mt-1 w-full" type="text" name="account_holder_name" :value="old('account_holder_name')" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="bic" class="block mt-1 w-full" type="text" name="bic" :value="old('bic')" required />
