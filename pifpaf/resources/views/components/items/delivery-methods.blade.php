...
<div class="bg-gray-50 p-4 rounded-lg border">
    ...
    <div class="space-y-3">
        @if ($item->pickup_available && $item->address)
            <label class="flex items-center p-3 border rounded-md has-[:checked]:bg-blue-50 has-[:checked]:border-blue-400 cursor-pointer transition-all duration-200 ease-in-out" dusk="delivery-method-pickup">
                ...
                <div class="ml-3 text-sm">
                    ...
                    <p class="text-gray-500">À {{ $item->address->city }}</p>
                </div>
            </label>
        @endif

        @if ($item->delivery_available)
            <label class="flex items-center p-3 border rounded-md has-[:checked]:bg-blue-50 has-[:checked]:border-blue-400 cursor-pointer transition-all duration-200 ease-in-out" dusk="delivery-method-delivery">
