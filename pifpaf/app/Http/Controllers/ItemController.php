...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'address_id' => ['required_if:pickup_available,true', 'nullable', Rule::exists('addresses', 'id')->where('user_id', Auth::id())], // Security: Scope address to Auth::id() to prevent IDOR
