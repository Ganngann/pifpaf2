...
class ItemController extends Controller
{
    ...
    public function update(Request $request, Item $item)
    {
        ...
        if ($request->hasFile('images')) {
            ...
            // ⚡ Bolt Optimization:
            // Extract image count before the loop to avoid N+1 query issue.
            // Expected impact: Eliminates a database count query on every loop iteration, improving file upload performance.
