...
class ItemController extends Controller
{
    ...
    public function update(Request $request, Item $item)
    {
        ...
        if ($request->hasFile('images')) {
            ...
            // ⚡ Bolt: Cache relationship count to avoid N+1 query problem inside the loop.
            // Expected performance impact: Eliminates O(N) database SELECT COUNT(*) queries,
            // replacing them with a single O(1) query before the loop and local variable increments.
