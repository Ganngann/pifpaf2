...
class ItemImageController extends Controller
{
    ...
    public function reorder(Request $request)
    {
        ...
        // Security Fix: Prevent IDOR by explicitly verifying authorization for EVERY item in the array.
        // Eager load the 'item' relationship to avoid N+1 query performance issues in the loop.
