...
## 2026-05-17 - Standardize empty states with x-ui.empty-state
**Learning:** Hardcoded empty states lead to inconsistent UI and miss opportunities for standard, accessible Call-to-Action placements.
**Action:** Always use `<x-ui.empty-state>` and place actionable links inside `<x-slot name="actions">`, applying primary button classes for consistency.
